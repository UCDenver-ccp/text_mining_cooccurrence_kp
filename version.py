def get_release(self):
    ...
    import requests
    res = requests.get("https://storage.googleapis.com/translator-tm-provider-knowledge-graphs/concept-cooccurrence/current/ngd-concept-cooccur.current.nodes.kgx.tsv.gz")
    try:
